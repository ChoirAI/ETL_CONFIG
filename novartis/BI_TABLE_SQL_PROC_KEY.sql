...
where nullif("CountryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CountryName" and bsl.range_local_name = "CountryName")
...
where nullif("CountryName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CountryName" and bsl.range_local_name = "CountryName_EN")
...
where nullif("CountryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CountryName" and bsl.range_local_name = "CountryName")
group by "CountryName"; --1
insert into bi_scope_lookup
...
where nullif("CountryName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CountryName" and bsl.range_local_name = "CountryName_EN")
group by "CountryName", "CountryName_EN"; --1
--province
insert into bi_scope_lookup
...
where nullif("ProvinceName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "ProvinceName" and bsl.range_local_name = "ProvinceName")
...
where nullif("ProvinceName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "ProvinceName" and bsl.range_local_name = "ProvinceName_EN")
...
where nullif("ProvinceName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "ProvinceName" and bsl.range_local_name = "ProvinceName")
group by "ProvinceName"; --33
insert into bi_scope_lookup
...
where nullif("ProvinceName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "ProvinceName" and bsl.range_local_name = "ProvinceName_EN")
group by "ProvinceName", "ProvinceName_EN"; --33
--city
insert into bi_scope_lookup
...
where nullif("CityName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CityName" and bsl.range_local_name = "CityName")
group by "CityName"; --368
insert into bi_scope_lookup
select gen_random_uuid() as id, now() as created_at, now() as updated_at, null as deleted_at, min("CityID") as range_external_id, "CityName" as range_standard_name, "CityName_EN"  as range_local_name, 'CN' as local_language, 'city' as "level", 'geography' as "type" from "Geography" g
where nullif("CityName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CityName" and bsl.range_local_name = "CityName_EN")
group by "CityName", "CityName_EN"; --368
insert into bi_scope_lookup
...
where nullif("CityName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CityName" and bsl.range_local_name = "CityName")
group by "CityName"; --368
insert into bi_scope_lookup
select gen_random_uuid() as id, now() as created_at, now() as updated_at, null as deleted_at, min("CityID") as range_external_id, "CityName" as range_standard_name, "CityName_EN"  as range_local_name, 'CN' as local_language, 'geo_territory_cluster' as "level", 'geo_and_org' as "type" from "Geography" g
where nullif("CityName_EN",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CityName" and bsl.range_local_name = "CityName_EN")
group by "CityName", "CityName_EN"; --368
--county
insert into bi_scope_lookup
...
where nullif("CityName"||"CountyName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CityName"||"CountyName" and bsl.range_local_name = "CityName"||"CountyName")
...
where nullif("CityName"||"CountyName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CityName"||"CountyName" and bsl.range_local_name = "CityName"||"CountyName")
and not exists (select 1 from bi_scope_lookup bsl where bsl.level in ('city') and bsl.range_standard_name = g."CountyName")
group by "CityName","CountyName"; --3180
...
where nullif("CityTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CityTier" and bsl.range_local_name = "CityTier" )
group by "CityTier"; --8
insert into bi_scope_lookup
select gen_random_uuid() as id, now() as created_at, now() as updated_at, null as deleted_at, "CityTier" as range_external_id, "CityTier" as range_standard_name, case "CityTier" when 'City-1' then '一线城市' when 'City-2' then '二线城市' when 'City-3' then '三线城市' when 'City-4a' then '四A线城市' when 'City-4b' then '四B线城市' else "CityTier" end as range_local_name, 'CN' as local_language, 'city_tier' as "level", 'geography' as "type" from "Geography" g
where nullif("CityTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CityTier" and bsl.range_local_name = case "CityTier" when 'City-1' then '一线城市' when 'City-2' then '二线城市' when 'City-3' then '三线城市' when 'City-4a' then '四A线城市' when 'City-4b' then '四B线城市' else "CityTier" end)
group by "CityTier"; --5
insert into bi_scope_lookup
...
where nullif("CityTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CityTier" and bsl.range_local_name = "CityTier" )
group by "CityTier"; --8
insert into bi_scope_lookup
select gen_random_uuid() as id, now() as created_at, now() as updated_at, null as deleted_at, "CityTier" as range_external_id, "CityTier" as range_standard_name, case "CityTier" when 'City-1' then '一线城市' when 'City-2' then '二线城市' when 'City-3' then '三线城市' when 'City-4a' then '四A线城市' when 'City-4b' then '四B线城市' else "CityTier" end as range_local_name, 'CN' as local_language, 'geo_territory_cluster' as "level", 'geo_and_org' as "type" from "Geography" g
where nullif("CityTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "CityTier" and bsl.range_local_name = case "CityTier" when 'City-1' then '一线城市' when 'City-2' then '二线城市' when 'City-3' then '三线城市' when 'City-4a' then '四A线城市' when 'City-4b' then '四B线城市' else "CityTier" end)
group by "CityTier"; --5
-- county_tier
insert into bi_scope_lookup
...
where nullif("CountyTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'geography' and bsl.range_standard_name = "CountyTier" and bsl.range_local_name = "CountyTier" )
...
and not exists (select 1 from bi_scope_lookup bsl where bsla."level" = bsl."level" and bsla."type" = bsl."type" and bsla.range_standard_name = bsl.range_standard_name and bsla.range_local_name = bsl.range_local_name )
...
where nullif("InstitutionName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'institution_name' and bsl.range_standard_name = i."InstitutionName" and bsl.range_local_name = i."InstitutionName")
...
where nullif("InstitutionTier",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'institution_tier' and bsl.range_standard_name = i."InstitutionTier" and bsl.range_local_name = i."InstitutionTier")
...
where nullif("InsProdProperty1",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'institution_product_segment' and bsl.range_standard_name = ipp."InsProdProperty1" and bsl.range_local_name = ipp."InsProdProperty1")
...
where nullif("SubInsType",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'sales_channel' and bsl.range_standard_name = itpccd."SubInsType" and bsl.range_local_name = itpccd."SubInsType")
...
where nullif("ListingStatus",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_listing_status' and bsl.range_standard_name = ipl."ListingStatus" and bsl.range_local_name = ipl."ListingStatus")
...
where nullif("ListingStatus",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_listing_status' and bsl.range_standard_name = ipl."ListingStatus" and bsl.range_local_name = ipl."ListingStatus_EN")
...
where nullif("BUHTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "BUHTerritoryName" and bsl.range_local_name = "BUHTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("BUHTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "BUHTerritoryName" and bsl.range_local_name = "BUHTerritoryName")
group by "BUHTerritoryID", "BUHTerritoryName"; --2
-- franchise_head
insert into bi_scope_lookup
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("FHTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "FHTerritoryName" and bsl.range_local_name = "FHTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("FHTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "FHTerritoryName" and bsl.range_local_name = "FHTerritoryName")
group by "FHTerritoryID", "FHTerritoryName"; --4
-- third_line_manager
insert into bi_scope_lookup
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("TLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "TLMTerritoryName" and bsl.range_local_name = "TLMTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("TLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "TLMTerritoryName" and bsl.range_local_name = "TLMTerritoryName")
group by "TLMTerritoryID", "TLMTerritoryName"; --12
-- second_line_manager
insert into bi_scope_lookup
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("SLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "SLMTerritoryName" and bsl.range_local_name = "SLMTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("SLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "SLMTerritoryName" and bsl.range_local_name = "SLMTerritoryName")
group by "SLMTerritoryID", "SLMTerritoryName"; --44
-- first_line_manager
insert into bi_scope_lookup
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("FLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "FLMTerritoryName" and bsl.range_local_name = "FLMTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("FLMTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "FLMTerritoryName" and bsl.range_local_name = "FLMTerritoryName")
group by "FLMTerritoryID", "FLMTerritoryName"; --270
-- rep_territory
insert into bi_scope_lookup
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("RepTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = "RepTerritoryName" and bsl.range_local_name = "RepTerritoryName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif("RepTerritoryName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'geo_territory_cluster' and bsl.range_standard_name = "RepTerritoryName" and bsl.range_local_name = "RepTerritoryName")
group by "RepTerritoryID", "RepTerritoryName"; --2050
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "BUHTerritoryName" and bsl.range_local_name = "BUHName")
group by "BUHName"; --2
insert into bi_scope_lookup
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "FHTerritoryName" and bsl.range_local_name = "FHName")
group by "FHName"; --2
insert into bi_scope_lookup
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "TLMTerritoryName" and bsl.range_local_name = "TLMName")
group by "TLMName"; --7
insert into bi_scope_lookup
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "SLMTerritoryName" and bsl.range_local_name = "SLMName")
group by "SLMName"; --40
insert into bi_scope_lookup
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "FLMTerritoryName" and bsl.range_local_name = "FLMName")
...
and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'full_name' and bsl.range_standard_name = "RepTerritoryName" and bsl.range_local_name = "RepName")
...
from "OrgCycle" oc
join "InsTrtyProductCycleData" itpcd on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and oc."Cycle" = (select max("Cycle") from public."InsTrtyProductCycleData" where "SalesValue" > 0)
where nullif(oc."RepProductLine",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'org_territory' and bsl.range_standard_name = oc."RepProductLine" and bsl.range_local_name = oc."RepProductLine")
...
where nullif(p."BrandName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'product' and bsl.range_standard_name = p."BrandName" and bsl.range_local_name = p."BrandName")
group by p."BrandName"; --26
insert into bi_scope_lookup
...
where nullif(amcd."ExternalProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'product' and bsl.range_standard_name = coalesce(pm."ProductName","ExternalProductName") and bsl.range_local_name = amcd."ExternalProductName")
group by amcd."ExternalProductName",pm."ProductName"; --97
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, max("ExternalProductID"), coalesce(pm."ProductName","ExternalProductName"), "ExternalProductName", 'CN', 'brand', 'product'
from "InsMarketCycleData" imcd
left join "ProductMapping" pm on imcd."ExternalProductID" = pm."CPA_ProductID"
where nullif(imcd."ExternalProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'product' and bsl.range_standard_name = coalesce(pm."ProductName","ExternalProductName") and bsl.range_local_name = imcd."ExternalProductName")
group by imcd."ExternalProductName",pm."ProductName"; --74
insert into bi_scope_lookup
...
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."BrandName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_cluster' and bsl.range_standard_name = p."BrandName" and bsl.range_local_name = p."BrandName")
group by p."BrandName"; --26
insert into bi_scope_lookup
...
from "AreaMarketCycleData" amcd
left join "ProductMapping" pm on amcd."ExternalProductID" = pm."IMS_ProductID"
where nullif(amcd."ExternalProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_cluster' and bsl.range_standard_name = coalesce(pm."ProductName","ExternalProductName") and bsl.range_local_name = amcd."ExternalProductName")
group by amcd."ExternalProductName",pm."ProductName"; --97
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, max("ExternalProductID"), coalesce(pm."ProductName","ExternalProductName"), "ExternalProductName", 'CN', 'product_cluster', 'product'
from "InsMarketCycleData" imcd
left join "ProductMapping" pm on imcd."ExternalProductID" = pm."CPA_ProductID"
where nullif(imcd."ExternalProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_cluster' and bsl.range_standard_name = coalesce(pm."ProductName","ExternalProductName") and bsl.range_local_name = imcd."ExternalProductName")
group by imcd."ExternalProductName",pm."ProductName"; --74
--        sku
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, max(p."ProductID"), p."ProductName", p."ProductName", 'CN', 'sku', 'product'
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."ProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'product' and bsl.range_standard_name = p."ProductName" and bsl.range_local_name = p."ProductName")
group by p."ProductName"; --38
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, max(p."ProductID"), p."ProductName", p."ProductName", 'CN', 'product_cluster', 'product'
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."ProductName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_cluster' and bsl.range_standard_name = p."ProductName" and bsl.range_local_name = p."ProductName")
group by p."ProductName"; --38
--product_lifecycle
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, p."ProductFeature", p."ProductFeature", p."ProductFeature", 'CN', 'product_lifecycle', 'product'
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."ProductFeature",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.type = 'product' and bsl.range_standard_name = p."ProductFeature" and bsl.range_local_name = p."ProductFeature")
group by p."ProductFeature"; --4
insert into bi_scope_lookup
...
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."ProductFeature",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_cluster' and bsl.range_standard_name = p."ProductFeature" and bsl.range_local_name = p."ProductFeature")
group by p."ProductFeature"; --4
...
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."PrimaryMarket",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_market' and bsl.range_standard_name = p."PrimaryMarket" and bsl.range_local_name = p."PrimaryMarket")
group by p."PrimaryMarket"; --12
insert into bi_scope_lookup
...
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."PrimaryMarket",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_market' and bsl.range_standard_name = p."PrimaryMarket" and bsl.range_local_name = p."ProductLevel4"||'市场')
group by p."PrimaryMarket"; --12
insert into bi_scope_lookup
...
from "Product" p join "InsTrtyProductCycleData" itpcd on itpcd."ProductID" = p."ProductID"
where nullif(p."PrimaryMarket",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_market' and bsl.range_standard_name = p."PrimaryMarket" and bsl.range_local_name = p."ProductLevel4_EN"||' Market')
group by p."PrimaryMarket"; --12
insert into bi_scope_lookup
...
from "AreaMarketCycleData" amcd
where nullif("MarketName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_market' and bsl.range_standard_name = "MarketName" and bsl.range_local_name = "MarketName")
group by "MarketName"; --0
insert into bi_scope_lookup
select gen_random_uuid() as id, NOW() as created_at, NOW() as updated_at, null as deleted_at, lower("MarketName"), "MarketName", "MarketName", 'CN', 'product_market', 'product'
from "InsMarketCycleData" imcd
where nullif("MarketName",'') is not null and not exists (select 1 from bi_scope_lookup bsl where bsl.level = 'product_market' and bsl.range_standard_name = "MarketName" and bsl.range_local_name = "MarketName")
...
and not exists (select 1 from bi_scope_lookup bsl where bsla."level" = bsl."level" and bsla."type" = bsl."type" and bsla.range_standard_name = bsl.range_standard_name and bsla.range_local_name = bsl.range_local_name )
group by bsla.range_standard_name, bsla.range_local_name, bsla."level", bsla."type"; --2448
...
join "OrgCycle" oc on itpcd."RepTerritoryCode" = oc."RepTerritoryID" and itpcd."Cycle" = oc."Cycle"
join "Product" pm on itpcd."ProductID" = pm."ProductID"
where not exists (select 1 from bi_scope_affiliation where scope1_range_std_name = oc."BUHTerritoryName" and scope2_range_std_name = pm."PrimaryMarket")
...
and pm."PrimaryMarket" not in ('LEQVIO INJ GLOBAL MKT')
group by oc."BUHTerritoryName", pm."PrimaryMarket";--16
INSERT INTO bi_scope_affiliation (id, created_at, updated_at, deleted_at, scope1_type, scope1_level, scope1_range_std_name, scope2_type, scope2_level, scope2_range_std_name, relation)
...
select
        ...
        array_agg(distinct products)filter(where products is not null) as products,
        array_agg(distinct markets)filter(where markets is not null) as markets,
        array_agg(distinct competitor_cpa)filter(where competitor_cpa is not null) as competitor_cpa,
        array_agg(distinct competitor_ims)filter(where competitor_ims is not null) as competitor_ims
from
                (select bup.user_id, oc."BUHTerritoryName", p."BrandName" as products, p."PrimaryMarket" as markets, null as competitor_cpa, null as competitor_ims
                from "InsTrtyProductCycleData" itpcd
                ...
                group by bup.user_id, oc."BUHTerritoryName", p."BrandName", p."PrimaryMarket"
                union
                select bup.user_id, tam."BUHTerritoryName", amcd."ProductName" as products, amcd."MarketName" as markets, null as competitor_cpa, amcd."ExternalProductName" as competitor_ims
                from "AreaMarketCycleData" amcd
                join "TerritoryAreaMapping" tam on amcd."ExternalAreaID" = tam."ExternalAreaID" and amcd."MarketName" = tam."MarketName"
                join bup on tam."BUHTerritoryName" = bup.element
                where amcd."MarketName" is not null
                group by bup.user_id, tam."BUHTerritoryName", amcd."ProductName", amcd."MarketName", amcd."ExternalProductName"
                union
                select bup.user_id, oc."BUHTerritoryName", imcd."ProductName" as products, imcd."MarketName" as markets, imcd."ExternalProductName" as competitor_cpa, null as competitor_ims
                from "InsMarketCycleData" imcd
                join "ProductMapping" pm on imcd."MarketName" = pm."Market" and pm."PriProductInMarket"
                ...
                group by bup.user_id, oc."BUHTerritoryName", imcd."ProductName", imcd."MarketName", imcd."ExternalProductName") a
group by user_id
...
select
        ...
        array_agg(distinct "FHTerritoryName")filter(where "FHTerritoryName" is not null) as territory,
        array_agg(distinct products)filter(where products is not null) as products,
        array_agg(distinct markets)filter(where markets is not null) as markets,
        array_agg(distinct competitor_cpa)filter(where competitor_cpa is not null) as competitor_cpa,
        array_agg(distinct competitor_ims)filter(where competitor_ims is not null) as competitor_ims
from
                (select bup.user_id, oc."FHTerritoryName", p."BrandName" as products, p."PrimaryMarket" as markets, null as competitor_cpa, null as competitor_ims
                from "InsTrtyProductCycleData" itpcd
                join "Product" p on itpcd."ProductID" = p."ProductID"
                join "OrgCycle" oc on oc."RepTerritoryID" = itpcd."RepTerritoryCode" and oc."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                join bup on oc."FHTerritoryName" = bup.element
                where p."BrandName" is not null
                group by bup.user_id, oc."FHTerritoryName", p."BrandName", p."PrimaryMarket"
                union
                select bup.user_id, tam."FHTerritoryName", amcd."ProductName" as products, amcd."MarketName" as markets, null as competitor_cpa, amcd."ExternalProductName" as competitor_ims
                from "AreaMarketCycleData" amcd
                join "TerritoryAreaMapping" tam on amcd."ExternalAreaID" = tam."ExternalAreaID" and amcd."MarketName" = tam."MarketName"
                join bup on tam."FHTerritoryName" = bup.element
                where amcd."MarketName" is not null
                group by bup.user_id, tam."FHTerritoryName", amcd."ProductName", amcd."MarketName", amcd."ExternalProductName"
                union
                select bup.user_id, oc."FHTerritoryName", imcd."ProductName" as products, imcd."MarketName" as markets, imcd."ExternalProductName" as competitor_cpa, null as competitor_ims
                from "InsMarketCycleData" imcd
                join "ProductMapping" pm on imcd."MarketName" = pm."Market" and pm."PriProductInMarket"
                join "Product" p on pm."ProductID" = p."BrandID" and p."IsStandardSKU"
                join "InsTrtyProductCycleData" itpcd on imcd."InstitutionID" = itpcd."InsID" and p."ProductID" = itpcd."ProductID" and itpcd."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                ...
                join bup on oc."FHTerritoryName" = bup.element
                where imcd."MarketName" is not null
                group by bup.user_id, oc."FHTerritoryName", imcd."ProductName", imcd."MarketName", imcd."ExternalProductName") a
group by user_id
...
select
        ...
        array_agg(distinct competitor_ims)filter(where competitor_ims is not null) as competitor_ims
from
                (select bup.user_id, oc."TLMTerritoryName", p."BrandName" as products, p."PrimaryMarket" as markets, null as competitor_cpa, null as competitor_ims
                from "InsTrtyProductCycleData" itpcd
                join "Product" p on itpcd."ProductID" = p."ProductID"
                join "OrgCycle" oc on oc."RepTerritoryID" = itpcd."RepTerritoryCode" and oc."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                join bup on oc."TLMTerritoryName" = bup.element
                where p."BrandName" is not null
                group by bup.user_id, oc."TLMTerritoryName", p."BrandName", p."PrimaryMarket"
                union
                select bup.user_id, tam."TLMTerritoryName", amcd."ProductName" as products, amcd."MarketName" as markets, null as competitor_cpa, amcd."ExternalProductName" as competitor_ims
                from "AreaMarketCycleData" amcd
                join "TerritoryAreaMapping" tam on amcd."ExternalAreaID" = tam."ExternalAreaID" and amcd."MarketName" = tam."MarketName"
                join bup on tam."TLMTerritoryName" = bup.element
                where amcd."MarketName" is not null
                group by bup.user_id, tam."TLMTerritoryName", amcd."ProductName", amcd."MarketName", amcd."ExternalProductName"
                union
                select bup.user_id, oc."TLMTerritoryName", imcd."ProductName" as products, imcd."MarketName" as markets, imcd."ExternalProductName" as competitor_cpa, null as competitor_ims
                from "InsMarketCycleData" imcd
                join "ProductMapping" pm on imcd."MarketName" = pm."Market" and pm."PriProductInMarket"
                join "Product" p on pm."ProductID" = p."BrandID" and p."IsStandardSKU"
                join "InsTrtyProductCycleData" itpcd on imcd."InstitutionID" = itpcd."InsID" and p."ProductID" = itpcd."ProductID" and itpcd."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                ...
                join bup on oc."TLMTerritoryName" = bup.element
                where imcd."MarketName" is not null
                group by bup.user_id, oc."TLMTerritoryName", imcd."ProductName", imcd."MarketName", imcd."ExternalProductName") a
group by user_id
...
select
        ...
        array_agg(distinct competitor_ims)filter(where competitor_ims is not null) as competitor_ims
from
                (select bup.user_id, oc."SLMTerritoryName", p."BrandName" as products, p."PrimaryMarket" as markets, null as competitor_cpa, null as competitor_ims
                from "InsTrtyProductCycleData" itpcd
                join "Product" p on itpcd."ProductID" = p."ProductID"
                join "OrgCycle" oc on oc."RepTerritoryID" = itpcd."RepTerritoryCode" and oc."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                join bup on oc."SLMTerritoryName" = bup.element
                where p."BrandName" is not null
                group by bup.user_id, oc."SLMTerritoryName", p."BrandName", p."PrimaryMarket"
                union
                select bup.user_id, tam."SLMTerritoryName", amcd."ProductName" as products, amcd."MarketName" as markets, null as competitor_cpa, amcd."ExternalProductName" as competitor_ims
                from "AreaMarketCycleData" amcd
                join "TerritoryAreaMapping" tam on amcd."ExternalAreaID" = tam."ExternalAreaID" and amcd."MarketName" = tam."MarketName"
                join bup on tam."SLMTerritoryName" = bup.element
                where amcd."MarketName" is not null
                group by bup.user_id, tam."SLMTerritoryName", amcd."ProductName", amcd."MarketName", amcd."ExternalProductName"
                union
                select bup.user_id, oc."SLMTerritoryName", imcd."ProductName" as products, imcd."MarketName" as markets, imcd."ExternalProductName" as competitor_cpa, null as competitor_ims
                from "InsMarketCycleData" imcd
                join "ProductMapping" pm on imcd."MarketName" = pm."Market" and pm."PriProductInMarket"
                join "Product" p on pm."ProductID" = p."BrandID" and p."IsStandardSKU"
                join "InsTrtyProductCycleData" itpcd on imcd."InstitutionID" = itpcd."InsID" and p."ProductID" = itpcd."ProductID" and itpcd."Cycle" = (select max("Cycle") from "InsTrtyProductCycleData" where "SalesValue">0)
                ...
                join bup on oc."SLMTerritoryName" = bup.element
                where imcd."MarketName" is not null
                group by bup.user_id, oc."SLMTerritoryName", imcd."ProductName", imcd."MarketName", imcd."ExternalProductName") a
group by user_id
order by products; --81

RAISE NOTICE 'Step1 Table bi_user_profile_to_refresh created';
...
RAISE NOTICE 'Step2 bi_user_profile refresh done';
